...
// Render loading template
export const renderTodosError = (message, full=true) => {
    ...
    if (full) document.querySelector("#task__actions").style.display = "none";
...
export const renderTodos = (incoming_tasks = null) => {
    ...
    if (filteredTodo.length < 1) {
        renderTodosError(`Your ${filter} tasks will show here`, false);
    }
    else{
