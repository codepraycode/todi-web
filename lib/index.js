...
import { listenForAuthSwitch, listenForSignin, 
        ...
        listenForTodosConnectionStatus, listenForTodosConnectionFailed
 } from './listeners';
import { 
    clearCompletedTodo, createTodo,
    deleteTodo, updateTodo,
    registerTaskConnectionListener, registerTasksUpdateListener,
    registerTaskFailedConnectionListener, USER_TOKEN,
    handleSignOut } from './script';
...
const renderAuthModal = (type=null, toClose=false) =>{    
